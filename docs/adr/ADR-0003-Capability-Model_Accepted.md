...
The Human Owner reviewed and accepted this ADR on 2026-08-03. The Capability Model remains revisable and must be reviewed after practical experience with two active production Domains.
...
Compatible clarification may amend this ADR. A materially different Capability contract must supersede it.
